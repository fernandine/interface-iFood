...
class RestaurantFragment : Fragment(R.layout.fragment_restaurant) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        categoryAdapter.items = arrayListOf(
            ...
            Category(
                5,
                "https://static-images.ifood.com.br/image/upload/t_high/discoveries/saudaveis_aTKz.png",
                "Saudável",
                0xFFE91D2D
            ),
            Category(
                6,
                "https://static-images.ifood.com.br/image/upload/t_high/discoveries/salgados_dTNG.png",
                "Salgados",
                0xFFE91D2D
            )
        )
